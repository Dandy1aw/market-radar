...
export const seedCoreWatchlist: OpportunityCoreTarget[] = [
  {
    ...
    priority: 1,
    is_active: true,
    notes: '存储芯片龙头，主营 DRAM/NAND/HBM，AI 服务器对高带宽内存需求驱动业绩。',
    created_at: now,
    updated_at: now,
  },
  {
    ...
    priority: 1,
    is_active: true,
    notes: 'AI 算力核心供应商，GPU/数据中心业务主导，估值高但需求能见度强。',
    created_at: now,
    updated_at: now,
  },
  {
    ...
    priority: 2,
    is_active: true,
    notes: 'CPU/GPU 双线厂商，AI 加速卡追赶 NVDA，服务器 CPU 已占据一定份额。',
    created_at: now,
    updated_at: now,
  },
  {
    ...
    priority: 1,
    is_active: true,
    notes: '跟踪纳斯达克100指数，覆盖科技/AI头部公司，流动性好，适合定投和大盘温度参考。',
    created_at: now,
    updated_at: now,
  },
  {
    ...
    priority: 2,
    is_active: true,
    notes: '半导体行业 ETF，持仓含 NVDA/TSM/ASML 等，用于判断板块整体趋势和拥挤度。',
    created_at: now,
    updated_at: now,
  },
];
